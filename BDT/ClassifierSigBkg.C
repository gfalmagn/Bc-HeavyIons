...
void Classifier(bool ispp = true, bool firstHalf=true){
  //Declare Factory
  ...
  loader.AddVariable("Bc_alpha3D","B_{c} #alpha 3D","",'F');
  ...
  loader.AddVariable("QQ_log_dca := TMath::Log(QQ_dca+1e-8)","J/#psi dimuon distance of closest approach","mm",'F');
  if(useVar_CorrWMass){
  ...
  TString cutSig = "Bc_M<6.25";
  TString cutBkg = "(Bc_M<6.25) || (bkgType==2)";
  ...
  if(addMCjpsi){
    loader.AddTree(tbkgBTOJPSI, "Background", 1.7,(TCut)(cutBkg+" && (eventNb%2)=="+(TString)(firstHalf?"0":"1")), TMVA::Types::kTraining);
    loader.AddTree(tbkgBTOJPSI, "Background", 1.7,(TCut)(cutBkg+" && (eventNb%2)=="+(TString)(firstHalf?"1":"0")), TMVA::Types::kTesting); 
    loader.AddTree(tbkgPROMPTJPSI, "Background", 1.,(TCut)(cutBkg+" && (eventNb%2)=="+(TString)(firstHalf?"0":"1")), TMVA::Types::kTraining);
    loader.AddTree(tbkgPROMPTJPSI, "Background", 1.,(TCut)(cutBkg+" && (eventNb%2)=="+(TString)(firstHalf?"1":"0")), TMVA::Types::kTesting); 
  }
  ...
  factory.BookMethod(&loader,TMVA::Types::kBDT, "BDTfiner"+(TString)(ispp?"":"_PbPb") +(TString)(addMCjpsi?"_withJpsiMC":"")+(TString)(useVar_CorrWMass?"":"_dropVarCorrWMass")+(TString)(firstHalf?"_1stHalf":"_2ndHalf"),
...
void ClassifierSigBkg(bool ispp=true){
  Classifier(ispp,true);
  Classifier(ispp,false);
}
