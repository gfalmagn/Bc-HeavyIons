...
void Classifier(bool ispp = true, bool firstHalf=true, int kinBin=0){
  ...
  loader.AddVariable("Bc_log_ctauSignif3D := TMath::Log(Bc_ctauSignif3D+1e-8)","Significance of non-zero B_{c} 3D lifetime","",'F'); //PROBLEMATIC, Bc_ctauSignif3D goes negative for signal_MC!
  ...
  factory.BookMethod(&loader,TMVA::Types::kBDT, 
		     "BDTfiner"+(TString)(ispp?"":"_PbPb") +(TString)(addMCjpsi?"_withJpsiMC":"")+(TString)(useVar_CorrWMass?"":"_dropVarCorrWMass")+(TString)(firstHalf?"_1stHalf":"_2ndHalf")+"_kinBin"+(TString)to_string(kinBin),
